        ...
        while (iter.hasNext()) {
            ...
            if (provider instanceof RegisterableService) {
                ...
                if (acc != null || System.getSecurityManager() == null) {
                    AccessController.doPrivileged(new NullPrivilegedAction(rs), acc);
...
//                    }, acc);
    ...
    class NullPrivilegedAction implements PrivilegedAction<Void>
    {
        private final RegisterableService rs;

        public NullPrivilegedAction(RegisterableService rs)
        {
            this.rs = rs;
        }
